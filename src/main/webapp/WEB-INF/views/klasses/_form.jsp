...
<t:form_with url="${UrlUtils.KLASSES_PATH}"> 
  <div class="field">
  ...
  <div class="form-group">
	...
	<input class="form-control" type="text" name="klass[semester]" id="klass_semester" />
  </div>

  <div class="form-group">
	<label for="klass_section">Section</label>
	<input class="form-control" type="number" name="klass[section]" id="klass_section" />
  </div>
