		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<h4 class="panel-title">
					<a data-toggle="collapse" href="#student_classes"><strong>Student Classes<span class="caret"></span>
					</strong></a>
				</h4>
			</div>
			...
			<div class="panel-body">
			  <div class="panel panel-default">
				<div class="panel-heading">
				  <h4 class="panel-title">
				    <a data-toggle="collapse" href="#current_student_classes"><strong>Current Classes<span class="caret"></span></strong></a>
				  </h4>
				</div>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
			  <div class="panel panel-default">
				<div class="panel-heading">
				  <h4 class="panel-title">
				    <a data-toggle="collapse" href="#current_grader_classes"><strong>Current Classes<span class="caret"></span></strong></a>
				  </h4>
				</div>
				<div id="current_grader_classes" class="panel-collapse collapse">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
			  <div class="panel panel-default">
				<div class="panel-heading">
				  <h4 class="panel-title">
				    <a data-toggle="collapse" href="#current_professor_classes"><strong>Current Classes<span class="caret"></span></strong></a>
				  </h4>
				</div>
				<div id="current_professor_classes" class="panel-collapse collapse">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
			  <div class="panel panel-default">
				<div class="panel-heading">
				  <h4 class="panel-title">
				    <a data-toggle="collapse" href="#current_all_classes"><strong>All Current Classes<span class="caret"></span></strong></a>
				  </h4>
				</div>
				<div id="current_all_classes" class="panel-collapse collapse">
