...
<t:layoutj pageTitle="Class Details">

	<div class="container">
		<ol class="breadcrumb">
			<li><a href="/klasses">Classes</a></li>
			<li class="active">COMP 110 Intro to Programming, pre-Hybrid:
				Spring 2019 1</li>
		</ol>

		<center>
			<h1>Intro to Programming, pre-Hybrid</h1>
			<h4>Spring 2019 section 1</h4>
		</center>
