...
```html
<!-- The anchor tag that triggers the modal -->
<a href="https://media.giphy.com/media/13HgwGsXF0aiGY/giphy.gif" data-target="myModal">
  <img src="https://media.giphy.com/media/13HgwGsXF0aiGY/giphy.gif" alt="Animated GIF" width="300" height="200">
</a>
...
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
    ...
    <video controls autoplay>
      <source src="https://media.giphy.com/media/13HgwGsXF0aiGY/giphy.gif" type="video/mp4">
      Your browser does not support the video tag.
    </video>
  </div>
</div>

<!-- CSS to style the modal and trigger its behavior -->
<style>
  /* Style the modal */
  .modal {
  ...
  /* Show the modal when the anchor tag is clicked */
  a[data-target]::after {
    content: "";
    display: block;
    position: fixed;
